...
ggsave(here("figures","mordor-ab-diff-mfi-enterics.png"),plot_mfi_comp_enterics,device = "png",width = 8, height = 3)
```
...
ggsave(here("figures","mordor-ab-diff-seroprev-enterics.png"),plot_serop_comp_enterics,device = "png",width = 8, height = 2.5)
```
...
ggsave(here("figures","mordor-ab-scr-hr-enterics.png"),plot_scr_comp,device = "png",width = 8, height = 2.5)
```
