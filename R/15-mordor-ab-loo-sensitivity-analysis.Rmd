...
ggsave(here("figures","mordor-ab-diff-seroprev-loo-sens.png"),loo_serop_plot,device = "png",width = 7, height = 6)
...
ggsave(here("figures","mordor-ab-hr-loo-sens.png"),loo_hr_plot,device = "png",width = 7, height = 6)
