...
# the analysis
#-------------------------------
public_clids <- read_csv("~/Box/mordor/mordor data/public-IDs/mordor-morbidity-public-IDs-cluster.csv")

public_ids <- read_csv("~/Box/mordor/mordor data/public-IDs/mordor-morbidity-public-IDs-child.csv") %>%
