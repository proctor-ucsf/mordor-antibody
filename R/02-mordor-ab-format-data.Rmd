...
# Diana Martin at CDC
#-------------------------------
d <- read_csv("~/Box sync/mordor/mordor data/data/untouched-dbs/MORDOR MBA Raw Data Compiled 100219.csv")
...
comd <- d4 %>%
  ...
  group_by(clusterid) %>%
  slice(1)
write_csv(comd,"~/box sync/mordor/mordor data/data/final-dbs/mordor-ab-tr.csv")
...
summary(d11)
write_rds(d11,"~/box sync/mordor/mordor data/data/final-dbs/mordor-ab-analysis.rds")
write_csv(d11,"~/box sync/mordor/mordor data/data/final-dbs/mordor-ab-analysis.csv")
...
#-------------------------------
dtr <-read_csv("~/Box sync/mordor/mordor data/data/final-morbidity/Stata-mordor-Niger-long-dedupe-forYing.csv")
...
#-------------------------------
summary(dtr4)
write_rds(dtr4,"~/box sync/mordor/mordor data/data/final-dbs/mordor-ab-treatment.rds")
write_csv(dtr4,"~/box sync/mordor/mordor data/data/final-dbs/mordor-ab-treatment.csv")
