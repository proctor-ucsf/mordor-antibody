...
mu_mfi_table <- mu_mfi2 %>%
  ...
  select(antigenf, phasef, placebo, azithro, diff_ci,intP,intPbh)

knitr::kable(mu_mfi_table,
             col.names = c("Pathogen, antigen", "Phase","Placebo","Azithro.","Difference (95% CI)","P-value*","Adj P-value†"), 
             digits = 3,
             align = "lccccc") %>%
...
knitr::kable(mu_serop_table,
             col.names = c("Pathogen, antigen","Phase", "Placebo","Azithromycin","Difference (95% CI)","P-value*","Adj P-value†"), 
             digits = c(0,0,2,2,0,3,3),
             align = "lccccc") %>%
  kable_styling(bootstrap_options = c("striped","condensed"),full_width = TRUE) %>%
...
mu_mfi_table <- mu_mfi2 %>%
  ...
  mutate(diff_ci = paste0(sprintf("%1.3f",diff)," (",sprintf("%1.3f",diff_lb),", ", sprintf("%1.3f",diff_ub),")")) %>%
  select(antigenf, agem_start_under6, placebo, azithro, diff_ci,intP, intPbh)

knitr::kable(mu_mfi_table,
             col.names = c("Pathogen, antigen", "<= 6 months at trial start","Placebo","Azithro.","Difference (95% CI)","P-value*","Adj P-value†"), 
             digits = 3,
             align = "lccccc") %>%
  kable_styling(bootstrap_options = c("striped","condensed"),full_width = TRUE) %>%
  add_header_above(c(" " = 2, "Mean log10\nLuminex Response (MFI-bg)" = 2,  " " = 3)) %>%
...
knitr::kable(mu_serop_table,
             col.names = c("Pathogen, antigen","<= 6 months at trial start", "Placebo","Azithromycin","Difference (95% CI)","P-value*","Adj P-value†"), 
             digits = c(0,0,2,2,0,3,3),
             align = "lccccc") %>%
  kable_styling(bootstrap_options = c("striped","condensed"),full_width = TRUE) %>%
  add_header_above(c(" " = 2, "Proportion\nSeropositive" = 2,  " " = 3)) %>%
