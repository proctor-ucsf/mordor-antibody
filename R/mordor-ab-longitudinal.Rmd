...
## Enterics comparison figure

Seroconversion rate panel

```{r plot seroconversion rates enterics}
...
Composite plot
```{r plot composite enterics, fig.height=3, fig.width = 12}
enterics_comp <- grid.arrange(plot_scr_enterics,plot_hr_enterics,ncol=2,nrow=1,widths=c(3,1))

ggsave(filename = here("figures","mordor-ab-long-v-cross-enterics.png"),enterics_comp,device = "png",height=3,width=10)
