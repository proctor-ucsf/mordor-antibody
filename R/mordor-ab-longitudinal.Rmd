...
dl4 <- dl3 %>%
  ...
  select(antigenf2,antigenf,clusterid,childid,phase,agem,age_diff,seropos,seroi4fold,seror4fold) %>%
  ...
  slice(1) %>%
  select(antigenf=antigenf2,clusterid,childid,phase,agem,age_diff,seropos,seroi4fold,seror4fold) %>%
  group_by(antigenf,childid) %>%
  arrange(antigenf,childid,phase) %>%
