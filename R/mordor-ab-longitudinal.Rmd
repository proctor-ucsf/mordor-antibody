...
rate_ests_tab <- rate_ests[c(8:16,1:7),] %>%
  ...
  kableExtra::group_rows("Bacteria and protozoans", 10,16) %>%
...
# put malaria on top
#-----------------------------
irr_ests_tab <- irr_ests[c(8:16,1:7),] %>%
...
knitr::kable(irr_ests_tab %>% select(antigenf,ni_a,nit_a,seroi_a_print,ni_p,nit_p,seroi_p_print,irr_print),
  ...
  kableExtra::group_rows(group_label = "Bacteria & protozoans", start_row = 10, end_row = 16) 
