...
#-------------------------------
d11 <- d10 %>%
  select(clusterid,phase,arm,agem,sex,pf_thicksmear,pf_density,pf_gameto,dbsid,type,well,pathogen,antigen,antigenf,mfi,logmfi,serocut,serocut_desc,seropos)
