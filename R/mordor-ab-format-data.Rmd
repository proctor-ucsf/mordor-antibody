...
d11 <- d10 %>%
  select(clusterid,phase,arm,childid,agem,agem_start, agem_start_under6, sex, 
         testdate,dose,trdate,med_trdate,diff_phase0,diff_phase,
...
dtr3 <- dtr2 %>%
  ...
  ungroup() %>%
  select(clusterid,phase,childid,agem,female,trdate,treated,dose)
...
#-------------------------------
summary(dtr3)
write_rds(dtr3,"~/box sync/mordor/mordor data/data/final-dbs/mordor-ab-treatment.rds")
write_csv(dtr3,"~/box sync/mordor/mordor data/data/final-dbs/mordor-ab-treatment.csv")
