...
#-------------------------------
d11 <- d10 %>%
  select(clusterid,phase,arm,childid,agem,agem_start, agem_start_under6, sex, testdate,dose,trdate,med_trdate,diff_phase0,diff_phase, pf_thicksmear,pf_density,pf_gameto,dbsid,type,well,pathogen,antigen,antigenf,mfi,logmfi,serocut,serocut_desc,seropos)
