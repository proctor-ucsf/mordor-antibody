...
#-------------------------------
d11 <- d10 %>%
  select(clusterid,phase,arm,childid,agem,sex,testdate,pf_thicksmear,pf_density,pf_gameto,dbsid,type,well,pathogen,antigen,antigenf,mfi,logmfi,serocut,serocut_desc,seropos)
